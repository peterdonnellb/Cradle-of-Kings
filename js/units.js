...
export const UNITS = {
  ...
  spearman: { id: 'spearman', name: 'Spearman', tier: 'basic', hp: 12, attack: 3, defense: 4, move: 1, cost: { food: 10, wood: 8 }, role: 'anti-cavalry', svg: token(glyphs.spearman) },
  ...
  // --- advanced ---
  shield_bearer: { id: 'shield_bearer', name: 'Shield Bearer', tier: 'advanced', hp: 16, attack: 3, defense: 6, move: 1, cost: { food: 15, copper: 5 }, req: 'bronze_working', role: 'tank', svg: token(glyphs.shield_bearer) },
  horseman: { id: 'horseman', name: 'Horseman', tier: 'advanced', hp: 14, attack: 5, defense: 2, move: 3, cost: { food: 20, horses: 10 }, req: 'mounted_warfare', role: 'cavalry', svg: token(glyphs.horseman) },
  camel_rider: { id: 'camel_rider', name: 'Camel Rider', tier: 'advanced', hp: 14, attack: 4, defense: 2, move: 3, cost: { food: 20, horses: 8 }, req: 'mounted_warfare', role: 'desert-cavalry', svg: token(glyphs.camel_rider) },
  axeman: { id: 'axeman', name: 'Axeman', tier: 'advanced', hp: 14, attack: 6, defense: 2, move: 1, cost: { food: 12, iron: 8 }, req: 'iron_working', role: 'melee', svg: token(glyphs.axeman) },
  ...
  // --- elite ---
  royal_guard: { id: 'royal_guard', name: 'Royal Guard', tier: 'elite', hp: 22, attack: 7, defense: 7, move: 1, cost: { food: 25, iron: 15, gold: 10 }, req: 'architecture', role: 'melee', svg: token(glyphs.royal_guard) },
  elephant_rider: { id: 'elephant_rider', name: 'Elephant Rider', tier: 'elite', hp: 26, attack: 8, defense: 5, move: 2, cost: { food: 30, ivory: 15 }, req: 'ivory', role: 'shock', svg: token(glyphs.elephant_rider) },
  war_chariot: { id: 'war_chariot', name: 'War Chariot', tier: 'elite', hp: 18, attack: 7, defense: 3, move: 4, cost: { food: 25, horses: 15, wood: 10 }, req: 'siege_weapons', role: 'cavalry', svg: token(glyphs.war_chariot) },
  crossbowman: { id: 'crossbowman', name: 'Crossbowman', tier: 'elite', hp: 15, attack: 8, defense: 2, move: 1, range: 2, cost: { food: 20, iron: 12 }, req: 'siege_weapons', role: 'ranged', svg: token(glyphs.crossbowman) },
  siege_tower: { id: 'siege_tower', name: 'Siege Tower', tier: 'elite', hp: 20, attack: 4, defense: 4, move: 1, cost: { food: 20, wood: 25 }, req: 'siege_weapons', role: 'siege', svg: token(glyphs.siege_tower) },
  catapult: { id: 'catapult', name: 'Catapult', tier: 'elite', hp: 14, attack: 10, defense: 1, move: 1, range: 3, cost: { food: 20, wood: 20, iron: 10 }, req: 'siege_weapons', role: 'siege', svg: token(glyphs.catapult) },
  // --- legendary ---
  lion_guard: { id: 'lion_guard', name: 'Lion Guard', tier: 'legendary', hp: 30, attack: 10, defense: 8, move: 2, cost: { food: 40, gold: 25 }, unique: true, role: 'melee', svg: token(glyphs.lion_guard, '#D8A93A') },
  spirit_shaman: { id: 'spirit_shaman', name: 'Spirit Shaman', tier: 'legendary', hp: 16, attack: 5, defense: 3, move: 2, range: 2, cost: { food: 30, gold: 20 }, unique: true, role: 'support', svg: token(glyphs.spirit_shaman, '#2E6B4F') },
  royal_elephant: { id: 'royal_elephant', name: 'Royal Elephant', tier: 'legendary', hp: 36, attack: 11, defense: 7, move: 2, cost: { food: 45, ivory: 25, gold: 15 }, unique: true, role: 'shock', svg: token(glyphs.royal_elephant, '#D8A93A') },
  great_general: { id: 'great_general', name: 'Great General', tier: 'legendary', hp: 24, attack: 9, defense: 6, move: 2, cost: { food: 35, gold: 30 }, unique: true, role: 'command', svg: token(glyphs.great_general, '#8C2F2F') },
};
