// units.js — Unit roster with stats + inline SVG token art (detailed cultural silhouettes)
...
const glyphs = {
  // ===== VILLAGER — Water carrier with pot balanced on head =====
  villager: `
    <circle cx="32" cy="16" r="7"/>
    <path d="M24 6 L40 6 L37 14 L27 14 Z"/>
    <path d="M25 14 Q32 18 39 14"/>
    <rect x="27" y="22" width="10" height="14" rx="3"/>
    <path d="M22 34 L42 34 L44 46 L20 46 Z"/>
    <rect x="26" y="44" width="6" height="12" rx="2"/>
    <rect x="32" y="44" width="6" height="12" rx="2"/>
    <path d="M27 26 L18 32 L22 36"/>
    <path d="M37 26 L46 32 L42 36"/>
  `,

  // ===== SCOUT — Hunter with running pose, spear and hide shield =====
  scout: `
    <circle cx="34" cy="18" r="7"/>
    <ellipse cx="30" cy="34" rx="8" ry="12" transform="rotate(-15 30 34)"/>
    <path d="M28 42 L22 56 M32 42 L40 56"/>
    <ellipse cx="22" cy="38" rx="9" ry="13"/>
    <rect x="40" y="22" width="6" height="16" rx="2"/>
    <line x1="16" y1="16" x2="44" y2="34"/>
    <path d="M44 34 L50 30 L48 38 Z"/>
    <path d="M40 22 L42 16 L44 22"/>
  `,

  // ===== WARRIOR — Maasai-style with shuka, shield and rungu =====
  warrior: `
    <circle cx="32" cy="16" r="8"/>
    <rect x="26" y="22" width="12" height="14" rx="4"/>
    <path d="M20 34 L44 34 L46 46 L18 46 Z"/>
    ...
    <path d="M16 22 L24 22 L24 44 L16 44 C10 44 10 22 16 22 Z"/>
    <line x1="40" y1="16" x2="48" y2="44"/>
    <circle cx="48" cy="44" r="6"/>
  `,

  // ===== SPEARMAN — Zulu-style with large Nguni shield and iklwa =====
  spearman: `
    <circle cx="34" cy="18" r="7"/>
    <rect x="30" y="24" width="10" height="14" rx="4"/>
    <rect x="26" y="44" width="6" height="12" rx="3"/>
    <rect x="34" y="44" width="6" height="12" rx="3"/>
    <ellipse cx="26" cy="34" rx="14" ry="22"/>
    <circle cx="22" cy="26" r="4"/>
    <circle cx="30" cy="30" r="5"/>
    <circle cx="24" cy="40" r="4"/>
    <line x1="46" y1="10" x2="38" y2="50"/>
    <path d="M46 10 L52 8 L48 16 Z"/>
  `,

  // ===== ARCHER — San/Bushman-style with bow and quiver =====
  archer: `
    <circle cx="32" cy="20" r="6"/>
    <ellipse cx="32" cy="34" rx="7" ry="11"/>
    <path d="M28 44 L24 56 M36 44 L40 56"/>
    <rect x="40" y="22" width="6" height="16" rx="2"/>
    <line x1="43" y1="22" x2="43" y2="38"/>
    <path d="M16 28 Q28 10 44 26 Q32 40 16 28"/>
    <line x1="20" y1="26" x2="48" y2="14"/>
    <path d="M48 14 L54 12 L50 20 Z"/>
  `,

  // ===== SHIELD BEARER — Heavy infantry with tower shield =====
  shield_bearer: `
    <circle cx="32" cy="14" r="6"/>
    <rect x="26" y="22" width="12" height="22" rx="4"/>
    <rect x="24" y="44" width="8" height="12" rx="3"/>
    <rect x="32" y="44" width="8" height="12" rx="3"/>
    <rect x="14" y="18" width="24" height="38" rx="4"/>
    <line x1="14" y1="30" x2="38" y2="30"/>
    <circle cx="26" cy="38" r="4"/>
    <line x1="48" y1="18" x2="42" y2="46"/>
    <ellipse cx="48" cy="16" rx="6" ry="4"/>
  `,

  // ===== HORSEMAN — Mounted cavalry with spear =====
  horseman: `
    <ellipse cx="32" cy="36" rx="18" ry="8"/>
    <line x1="18" y1="44" x2="16" y2="56"/>
    <line x1="26" y1="44" x2="24" y2="56"/>
    <line x1="38" y1="44" x2="40" y2="56"/>
    <line x1="46" y1="44" x2="48" y2="56"/>
    <rect x="46" y="28" width="12" height="8" rx="4"/>
    <circle cx="56" cy="32" r="3"/>
    <rect x="26" y="22" width="10" height="16" rx="3"/>
    <circle cx="31" cy="18" r="6"/>
    <line x1="50" y1="18" x2="44" y2="40"/>
  `,

  // ===== CAMEL RIDER — Desert skirmisher on camel =====
  camel_rider: `
    <ellipse cx="32" cy="38" rx="16" ry="8"/>
    <line x1="20" y1="46" x2="18" y2="56"/>
    <line x1="28" y1="46" x2="26" y2="56"/>
    <line x1="36" y1="46" x2="38" y2="56"/>
    <line x1="44" y1="46" x2="46" y2="56"/>
    <path d="M44 34 Q54 24 50 14"/>
    <ellipse cx="50" cy="14" rx="6" ry="4"/>
    <rect x="28" y="22" width="8" height="16" rx="3"/>
    <circle cx="32" cy="18" r="6"/>
    <line x1="18" y1="16" x2="28" y2="30"/>
  `,

  // ===== AXEMAN — Heavy shock troops with feathered headdress =====
  axeman: `
    <circle cx="32" cy="18" r="8"/>
    <rect x="24" y="24" width="16" height="20" rx="4"/>
    <rect x="26" y="44" width="8" height="12" rx="3"/>
    <rect x="34" y="44" width="8" height="12" rx="3"/>
    <path d="M24 12 L20 4 L28 10 M28 10 L32 2 L34 10 M34 10 L40 4 L40 12"/>
    <line x1="44" y1="14" x2="52" y2="46"/>
    <path d="M48 22 L58 18 L56 28 Z"/>
  `,

  // ===== SLINGER — Light skirmisher with sling =====
  slinger: `
    <circle cx="34" cy="20" r="7"/>
    <ellipse cx="30" cy="34" rx="7" ry="11" transform="rotate(10 30 34)"/>
    <path d="M26 44 L22 56 M34 44 L40 56"/>
    <path d="M14 30 Q22 38 28 28"/>
  ...
  royal_guard: `
    <circle cx="32" cy="16" r="8"/>
    <rect x="24" y="22" width="16" height="22" rx="4"/>
    <path d="M18 26 L46 26 L48 48 L16 48 Z"/>
    <rect x="24" y="44" width="8" height="12" rx="3"/>
    <rect x="34" y="44" width="8" height="12" rx="3"/>
    <path d="M22 10 L42 10 L44 16 L20 16 Z"/>
    <circle cx="32" cy="8" r="4"/>
    <ellipse cx="22" cy="34" rx="8" ry="14"/>
    <line x1="46" y1="12" x2="40" y2="50"/>
    <path d="M46 12 L52 10 L48 18 Z"/>
  `,

  // ===== ELEPHANT RIDER — War elephant with howdah and riders =====
  elephant_rider: `
    <ellipse cx="32" cy="36" rx="22" ry="14"/>
    <rect x="14" y="48" width="8" height="10" rx="3"/>
    <rect x="24" y="48" width="8" height="10" rx="3"/>
    <rect x="40" y="48" width="8" height="10" rx="3"/>
    <rect x="50" y="48" width="8" height="10" rx="3"/>
    <path d="M52 30 Q64 30 62 44 Q60 50 56 48 Q58 42 56 38"/>
    <path d="M52 36 L62 34 L60 38 Z"/>
    <path d="M54 38 L64 38 L60 42 Z"/>
    <rect x="22" y="22" width="20" height="6" rx="2"/>
    <rect x="26" y="14" width="6" height="10"/>
    <circle cx="29" cy="12" r="4"/>
    <rect x="34" y="14" width="6" height="10"/>
    <circle cx="37" cy="12" r="4"/>
    <path d="M20 14 L44 14 L40 18 L24 18 Z"/>
  `,

  // ===== WAR CHARIOT — Two horses pulling a chariot =====
  war_chariot: `
    <rect x="40" y="32" width="18" height="8" rx="4"/>
    <line x1="42" y1="40" x2="40" y2="52"/>
    <line x1="52" y1="40" x2="54" y2="52"/>
    <ellipse cx="58" cy="32" rx="4" ry="6"/>
    <rect x="14" y="34" width="22" height="10" rx="3"/>
    <circle cx="18" cy="48" r="8"/>
    <circle cx="32" cy="48" r="8"/>
    <line x1="18" y1="48" x2="18" y2="40"/>
    <line x1="32" y1="48" x2="32" y2="40"/>
    <rect x="18" y="24" width="6" height="12"/>
    <circle cx="21" cy="20" r="5"/>
    <rect x="28" y="24" width="6" height="12"/>
    <circle cx="31" cy="20" r="5"/>
    <line x1="14" y1="18" x2="34" y2="26"/>
    <path d="M14 18 L10 16 L12 22 Z"/>
  `,

  // ===== CROSSBOWMAN — Ranged mercenary with crossbow =====
  crossbowman: `
    <circle cx="32" cy="18" r="8"/>
    <rect x="24" y="24" width="16" height="20" rx="4"/>
    <rect x="26" y="44" width="8" height="12" rx="3"/>
    <rect x="34" y="44" width="8" height="12" rx="3"/>
    <path d="M22 14 L42 14 L40 18 L24 18 Z"/>
    <rect x="18" y="30" width="18" height="4" rx="2"/>
    <line x1="18" y1="26" x2="18" y2="34"/>
    <line x1="16" y1="26" x2="16" y2="34"/>
    <line x1="36" y1="32" x2="48" y2="28"/>
    <path d="M48 28 L52 26 L50 30 Z"/>
  `,

  // ===== SIEGE TOWER — Rolling assault tower with arrow slits =====
  siege_tower: `
    <rect x="16" y="14" width="32" height="38" rx="4"/>
    ...
    <line x1="25" y1="14" x2="25" y2="10"/>
    <line x1="41" y1="14" x2="41" y2="10"/>
    <circle cx="22" cy="52" r="6"/>
    <circle cx="42" cy="52" r="6"/>
  `,

  // ===== CATAPULT — Siege engine with throwing arm =====
  catapult: `
    <rect x="12" y="40" width="40" height="8" rx="3"/>
    <circle cx="18" cy="50" r="8"/>
    <circle cx="46" cy="50" r="8"/>
    <rect x="16" y="38" width="32" height="6" rx="2"/>
    <line x1="24" y1="38" x2="44" y2="18"/>
    <path d="M20 38 L28 38 L28 46 L20 46 Z"/>
    <path d="M44 18 L52 16 L50 24 Z"/>
  ...
  lion_guard: `
    ...
    <rect x="32" y="44" width="8" height="12" rx="3"/>
    <rect x="24" y="24" width="16" height="20" rx="4"/>
    <path d="M18 18 C10 10 10 30 18 22 C26 34 38 34 46 22 C54 30 54 10 46 18 C38 6 26 6 18 18 Z"/>
    <circle cx="32" cy="18" r="8"/>
    <line x1="46" y1="16" x2="50" y2="44"/>
    <path d="M50 44 L54 46 L50 48 Z"/>
    <ellipse cx="20" cy="34" rx="6" ry="12"/>
  `,

  // ===== SPIRIT SHAMAN — Ritual mask, staff and spirit orbs =====
  spirit_shaman: `
    <path d="M20 44 L44 44 L48 56 L16 56 Z"/>
    <rect x="24" y="22" width="16" height="24" rx="4"/>
    <path d="M22 12 L42 12 L44 28 L32 34 L20 28 Z"/>
    <ellipse cx="28" cy="20" rx="3" ry="5"/>
    <ellipse cx="36" cy="20" rx="3" ry="5"/>
    <line x1="48" y1="10" x2="44" y2="50"/>
  ...
  // ===== ROYAL ELEPHANT — Command elephant with royal howdah =====
  royal_elephant: `
    <ellipse cx="32" cy="36" rx="24" ry="16"/>
    <rect x="12" y="50" width="10" height="8" rx="3"/>
    <rect x="24" y="50" width="10" height="8" rx="3"/>
    <rect x="40" y="50" width="10" height="8" rx="3"/>
    <rect x="52" y="50" width="10" height="8" rx="3"/>
    <path d="M54 30 Q66 30 64 46 Q62 54 56 50 Q60 42 58 38"/>
    <path d="M54 36 L66 32 L64 38 Z"/>
    <path d="M56 40 L68 38 L64 44 Z"/>
    <rect x="20" y="20" width="24" height="8" rx="3"/>
    <path d="M16 12 L48 12 L44 18 L20 18 Z"/>
    <path d="M22 12 L30 4 L38 12 Z"/>
  ...
  // ===== GREAT GENERAL — Legendary commander with crown and staff =====
  great_general: `
    <ellipse cx="32" cy="52" rx="22" ry="6"/>
    <rect x="24" y="42" width="10" height="12" rx="3"/>
    <rect x="34" y="42" width="10" height="12" rx="3"/>
    <path d="M18 24 L46 24 L48 48 L16 48 Z"/>
    <rect x="22" y="22" width="20" height="22" rx="4"/>
    <circle cx="32" cy="16" r="10"/>
    <path d="M20 10 L44 10 L46 16 L18 16 Z"/>
    <circle cx="32" cy="6" r="8"/>
    <path d="M24 6 L40 6 L32 14 Z"/>
    <line x1="48" y1="8" x2="44" y2="48"/>
    <ellipse cx="48" cy="8" rx="8" ry="4"/>
    <ellipse cx="18" cy="34" rx="8" ry="16"/>
  `,
};
