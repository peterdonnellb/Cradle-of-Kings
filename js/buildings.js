...
const glyphs = {
  ...
  walls: `<rect x="6" y="20" width="7" height="10" fill="#726A5A" stroke="${OUT}" stroke-width="1"/><rect x="13" y="20" width="7" height="10" fill="#8D8474" stroke="${OUT}" stroke-width="1"/>
    <rect x="20" y="20" width="7" height="10" fill="#655E51" stroke="${OUT}" stroke-width="1"/><rect x="27" y="20" width="7" height="10" fill="#8D8474" stroke="${OUT}" stroke-width="1"/>
    <rect x="6" y="15" width="28" height="5" fill="#655E51" stroke="${OUT}" stroke-width="1"/>
    <rect x="7" y="11" width="3.4" height="4" fill="#655E51" stroke="${OUT}" stroke-width="0.7"/><rect x="13" y="11" width="3.4" height="4" fill="#655E51" stroke="${OUT}" stroke-width="0.7"/>
    <rect x="19" y="11" width="3.4" height="4" fill="#655E51" stroke="${OUT}" stroke-width="0.7"/><rect x="25" y="11" width="3.4" height="4" fill="#655E51" stroke="${OUT}" stroke-width="0.7"/><rect x="31" y="11" width="3" height="4" fill="#655E51" stroke="${OUT}" stroke-width="0.7"/>`,
  forge: `<rect x="12" y="18" width="16" height="12" fill="#2E2E32" stroke="${OUT}" stroke-width="1"/><rect x="12" y="18" width="8" height="12" fill="#3E3E42" stroke="${OUT}" stroke-width="1"/>
    <circle cx="20" cy="14" r="6.5" fill="#7A2510"/><circle cx="20" cy="14" r="6.5" fill="none" stroke="${OUT}" stroke-width="1"/>
    <circle cx="20" cy="14" r="3.6" fill="#C6491F"/><circle cx="20" cy="13" r="1.6" fill="#F1CE73"/>`,
